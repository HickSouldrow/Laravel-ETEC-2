...
<head>
    ...
    <title>Política de Privacidade - ETEC Zona Leste</title>
...
<body class="bg-gray-100 min-h-screen flex flex-col" x-data="{ sidebarOpen: false }">
    ...
    <main class="flex-1">
        <!-- Hero Banner -->
        <div class="relative">
            <img src="{{ asset('img/etec7.jpeg') }}" alt="ETEC Zona Leste" class="w-full h-64 object-cover">
            <div class="absolute inset-0 bg-overlay flex items-center justify-center">
                <h1 class="text-white text-3xl font-bold">Política de Privacidade</h1>
            </div>
        </div>
        ...
        <section class="py-12 bg-white">
            <div class="container mx-auto px-4">
                <div class="max-w-4xl mx-auto bg-gray-50 rounded-lg p-8 privacy-card">
                    <h2 class="text-3xl font-bold text-red-700 mb-6 text-center">Nossa Política de Privacidade</h2>
                    
                    <div class="prose max-w-none">
                        <p class="text-gray-700 mb-6">
                            Esta política descreve como a ETEC Zona Leste coleta, usa e protege as informações dos usuários deste site.
                        </p>
                        
                        <h3 class="text-xl font-semibold text-red-700 mb-3">1. Informações Coletadas</h3>
                        <p class="text-gray-700 mb-6">
                            Podemos coletar informações como nome, e-mail e telefone quando você preenche formulários de contato ou cadastro. Dados de navegação como IP e cookies também podem ser coletados.
                        </p>
                        
                        <h3 class="text-xl font-semibold text-red-700 mb-3">2. Uso das Informações</h3>
                        <p class="text-gray-700 mb-6">
                            Utilizamos suas informações para:
                            <ul class="list-disc pl-5 mb-6 space-y-2">
                                <li>Responder suas solicitações de contato</li>
                                <li>Melhorar nossos serviços e comunicação</li>
                                <li>Enviar informações sobre cursos e eventos (se autorizado)</li>
                            </ul>
                        </p>
                        
                        <h3 class="text-xl font-semibold text-red-700 mb-3">3. Compartilhamento de Dados</h3>
                        <p class="text-gray-700 mb-6">
                            Não vendemos ou compartilhamos seus dados pessoais com terceiros, exceto quando exigido por lei ou para prestação de serviços essenciais.
                        </p>
                        
                        <h3 class="text-xl font-semibold text-red-700 mb-3">4. Cookies</h3>
                        <p class="text-gray-700 mb-6">
                            Utilizamos cookies para melhorar a experiência no site. Você pode desativá-los nas configurações do seu navegador.
                        </p>
                        
                        <h3 class="text-xl font-semibold text-red-700 mb-3">5. Segurança</h3>
                        <p class="text-gray-700 mb-6">
                            Implementamos medidas de segurança para proteger suas informações contra acesso não autorizado ou divulgação.
                        </p>
                        
                        <h3 class="text-xl font-semibold text-red-700 mb-3">6. Seus Direitos</h3>
                        <p class="text-gray-700 mb-6">
                            Você tem direito a:
                            <ul class="list-disc pl-5 mb-6 space-y-2">
                            ...
                            Para exercer esses direitos, entre em contato através do nosso formulário.
                        </p>
                        
                        <h3 class="text-xl font-semibold text-red-700 mb-3">7. Alterações na Política</h3>
