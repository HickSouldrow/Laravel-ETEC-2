...
<body class="bg-gray-900 text-red-400 min-h-screen flex flex-col">
    ...
    <section class="relative h-[80vh] min-h-[400px] flex items-center overflow-hidden mt-10">
        ...
        <div class="container mx-auto px-4 relative z-10 text-center">
            <h1 class="text-4xl md:text-6xl font-extrabold mb-4 bg-gradient-to-r from-gray-100 to-red-400 bg-clip-text text-transparent">
                Fique de Olho em Nossos Contatos!
            </h1>
        </div>
    </section>
    <main class="container mx-auto px-4 py-12 max-w-6xl">
        ...
        <div class="bg-gray-800 p-6 mt-6 rounded-lg shadow-lg">
            <h3 class="text-xl font-semibold text-red-400 mb-4">Informações do Contato</h3>
            <p class="text-gray-300 mb-2"><strong>Endereço:</strong> Av. Águia de Haia, 2.633 - Cidade AE Carvalho, São Paulo - SP, 03694-000</p>
            <p class="text-gray-300 mb-2"><strong>Telefone:</strong> (11) 98353-2613</p>
            <p class="text-gray-300 mb-2"><strong>E-mail:</strong> EtecZonaLesteCentroPaulaSousa.sp.gov.br</p>
        </div>
    </main>
