...
<body class="bg-gray-900 text-red-400 min-h-screen flex flex-col">
    ...
    <section class="relative h-[80vh] min-h-[400px] flex items-center overflow-hidden mt-10">
        <img src="{{ asset('img/etec3.jpeg') }}" alt="ETEC" class="absolute inset-0 w-full h-full object-cover opacity-30">
        ...
        <div class="container mx-auto px-4 relative z-10 text-center">
            <h1 class="text-4xl md:text-6xl font-extrabold mb-4 bg-gradient-to-r from-gray-100 to-red-400 bg-clip-text text-transparent">
                Se torne nosso aluno!
            </h1>
        </div>
    </section>

    <main class="container mx-auto px-4 py-12 grid gap-8 max-w-6xl mb-12">
        <h1 class="text-4xl font-bold text-red-400 text-center mb-8">Cursos Oferecidos</h1>
        
        <div class="grid md:grid-cols-2 gap-6">
            <div class="p-6 bg-gray-800 rounded-lg shadow-lg hover:shadow-red-700">
                <h2 class="text-2xl font-semibold text-red-400">Cursos Técnicos - Modalidade Presencial</h2>
                <ul class="text-gray-300 list-disc pl-6">
                    <li>Administração</li>
                    <li>Contabilidade</li>
            ...
            <div class="p-6 bg-gray-800 rounded-lg shadow-lg hover:shadow-red-700">
                <h2 class="text-2xl font-semibold text-red-400">Ensino Médio Integrado ao Técnico (M-Tec)</h2>
                <ul class="text-gray-300 list-disc pl-6">
                    <li>Administração</li>
                    <li>Desenvolvimento de Sistemas</li>
                    <li>Logística</li>
            ...
            <div class="p-6 bg-gray-800 rounded-lg shadow-lg hover:shadow-red-700">
                <h2 class="text-2xl font-semibold text-red-400">Ensino Médio Integrado ao Técnico Noturno (M-Tec-N)</h2>
                <ul class="text-gray-300 list-disc pl-6">
                    <li>Logística</li>
                </ul>
            </div>
            <div class="p-6 bg-gray-800 rounded-lg shadow-lg hover:shadow-red-700">
                <h2 class="text-2xl font-semibold text-red-400">Articulação dos Ensinos Médio, Técnico e Superior (AMS)</h2>
                <ul class="text-gray-300 list-disc pl-6">
                    <li>Desenvolvimento de Sistemas</li>
                </ul>
            </div>
